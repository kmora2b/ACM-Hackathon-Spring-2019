    ...
    <body>
        <nav>
            <div class = "topNav" id = "myTopNav">
                ...
                <h3 class = "topNavItem"><strong><a href = "community-calendar.php">Community Calendar</a></strong></h3> 
				<h3 class = "topNavItem"><strong><a href = "profile.php">Profile</a></strong></h3>
                <h3 class = "topNavItem"><strong><a href = "volunteer-log.php">Volunteer Log</a></strong></h3>
                <h3 class = "topNavItem"><strong><a href = "profile.php">Welcome!</a></strong></h3>
